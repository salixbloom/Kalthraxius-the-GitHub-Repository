 ...
 *   KAL_SCRAPE_URL      URL to scrape (default: the descriptor's baseUrl)
...
async function main(): Promise<void> {
  ...
  console.log(`[scraper] platform=${descriptor.id} url=${url} stealth=${stealth} interval=${intervalMs}ms`)
